...
export function createApp({ pool, config, logger = console } = {}) {
  ...
  app.get('/api/judge/teams/:teamId/presentation', ...role('judge'), (req, res, next) => sendPresentation(req.params.teamId, res, next));
